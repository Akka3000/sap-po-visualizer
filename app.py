...
# Fixa utseendet
fig.update_xaxes(range=[denna_manad_start - relativedelta(months=1), horisont_slut + relativedelta(months=1)], dtick="M1", tickformat="%b %Y", ticklabelmode="period", showgrid=True)
